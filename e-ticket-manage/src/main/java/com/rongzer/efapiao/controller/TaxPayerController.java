...
import com.rongzer.efapiao.service.TaxPayerService;
...
public class TaxPayerController {
    private static final Logger log = Logger.getLogger(TaxPayerController.class);
    ...
    public String importData(@RequestParam(value = "file", required = false) MultipartFile file, HttpServletRequest request, ModelMap model) {
        ...
        try {
            ...
            errorInfo=taxPayerService.readExcel(path,fileName,userId);
        ...
        return "rdp/taxpayer/taxpayer-import";
    }
}
