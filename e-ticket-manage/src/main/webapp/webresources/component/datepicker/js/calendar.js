...
// $Id: calendar.js,v 1.1 2011/12/16 01:11:19 administrator Exp $
...
/**
 *去掉英文日期格式，需要的时候再打开 modifytime：2011-4-23
...
Calendar.prototype.showAtElement = function (el, opts) {
	...
	/**
	 * 2010-11-20添加
	 * 保证当日期选择框所在表格有滚动条时，能正确将日期选择框显示在文本输入框的正下方
	 */
	var pos=getElementAbsolutePosition(el);
	p.x=pos.left;
	p.y=pos.top;
