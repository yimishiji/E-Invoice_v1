	...
	var forTree = function(o){
		for(var i=0;i<o.length;i++){
			...
			try{
				...
				urlstr = "<li class='"+classType+"'><a href='"+url+"' class='J_menuItem nav_img "+o[i]["icon"]+"' target='frmright'><span class='nav-label'>"+ o[i]["name"] +"</span></a><ul class='nav'>";
				str += urlstr;
				if(o[i]["nodes"][0] != null){
					forTree(o[i]["nodes"]);
				}
	...
	var forTree = function(o){
		for(var i=0;i<o.length;i++){
			...
			try{
				...
				urlstr = "<li class=''><a href='"+url+"' class='J_menuItem nav_img "+o[i]["icon"]+"' target='frmright'><span class='nav-label'>"+ o[i]["name"] +"</span></a><ul class='nav'>";
				str += urlstr;
				if(o[i]["nodes"] != null){
					forTree(o[i]["nodes"]);
				}
...
function initECALeftNavUtil(funcId,webId,webType){
	$(".roll-nav").not('.J_tabExit').show();
	$("#side-menu").show();
	$("#page-wrapper .logo").hide();
	$(".navbar-default").show();
	...
	var forTree = function(o){
		for(var i=0;i<o.length;i++){
			...
			try{
				...
				url = url+"&FK_TEMP_ID="+webId+"&CLASS_TYPE="+webType;
				urlstr = "<li class=''><a href='"+url+"' class='J_menuItem nav_img "+o[i]["icon"]+"' target='frmright'><span class='nav-label'>"+ o[i]["name"] +"</span></a><ul class='nav'>";
				str += urlstr;
				if(o[i]["nodes"] != null){
					forTree(o[i]["nodes"]);
...
function initShowMenuLeftNavUtil(funcId,webId,webType,channelName,storeId,channelId){
	$(".roll-nav").not('.J_tabExit').show();
	$("#side-menu").show();
	$("#page-wrapper .logo").hide();
	$(".navbar-default").show();
	...
	var forTree = function(o){
		for(var i=0;i<o.length;i++){
			...
			try{
				...
				url = url+"&FK_TEMP_ID="+webId+"&CLASS_TYPE="+webType+"&FK_STORE_ID="+storeId+"&FK_CHANNEL_ID="+channelId;
				urlstr = "<li class=''><a href='"+url+"' class='J_menuItem nav_img "+o[i]["icon"]+"' target='frmright'><span class='nav-label'>"+ o[i]["name"] +"</span></a><ul class='nav'>";
				str += urlstr;
				if(o[i]["nodes"] != null){
					forTree(o[i]["nodes"]);
