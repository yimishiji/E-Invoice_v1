...
<%
	...
	if (StringUtil.isNotEmpty(strWebId))
	{
	   strWebId = "&WEB_ID="+strWebId+"&WEB_TYPE="+strWebType;
	}
%>	
</head>
<body> 
    ...
    <div position="left">
			<div id="lbox">
				...
				<div id="lbox_middleright">
						...
						<IFRAME height="100%" width="100%"  frameBorder=0 id=frmleft name=frmleft src="${ctx}/cms/CMSLeftTree.htm?funcid=M1100<%=strWebId%>"  allowTransparency="true"></IFRAME>
						</div>
