	    	    		...
	    	    		<div class="content">
	    	    			<#assign tradeinfoMap=result.tradeinfos>
	    	    				...
	    	    				<#list tradeinfoMap as invoiceInfo>	    	    			  	    						            
					                              ...
					                              <div class="trans_info_his">
													<div class="trans_info_content">
														<div class="content_line">
															...
															<b class="trans_his_yikaipiao">已开票</b>
														</div>
														<div class="content_line">
															<#if invoiceInfo.recordFlag ==  0>
                                                    			<b class="trans_order">${invoiceInfo.TRANSACTION_NUMBER}</b>
															<#elseif invoiceInfo.recordFlag ==  1>
                                                    			<b class="trans_order">多个订单</b>
															</#if>
														</div>
														<div class="content_line_his">
															<b class="trans_his_amount"><span style="color:#E14E2E">${invoiceInfo.TOTAL_AMOUNT}</span>元</b>
														</div>
													</div>
												</div>
											</li>
			    	    			...
			    	    			<#else>
			    	    			   <div class="history_none">暂无开票历史数据</div>	     	    	
	    	    				</#if>
	    	    			</div>
	    	    			</div>				    	
	    	    </section>	    	    
    ...
    <script type="text/javascript">
	    ...
	    $(".trans_list_container").click(function(event) {
			...
			businessExec(
				...
				function(data){
					if(data.suc){
						window.location.href= "${invoiceEnd.linkURL}";
					}
				});
	   });
    </script>
